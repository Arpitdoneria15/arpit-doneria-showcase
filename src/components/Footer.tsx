...
const Footer = () => {
  ...
  return (
    <footer className="py-12 bg-gradient-to-b from-background to-secondary relative overflow-hidden">
      <div className="absolute inset-0 bg-grid-pattern opacity-5 pointer-events-none"></div>
      
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex flex-col items-center">
          <a href="#" className="text-xl font-display font-bold mb-6">ARPIT DONERIA</a>
          ...
          <div className="w-24 h-0.5 bg-primary/10 rounded-full mb-8"></div>
