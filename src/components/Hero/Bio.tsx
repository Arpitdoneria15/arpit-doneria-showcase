...
const Bio = ({ isVisible }: BioProps) => {
  return (
    <div className={`max-w-xl transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      <div className="bg-gradient-to-r from-ocean-blue/10 to-vivid-purple/10 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:from-ocean-blue/15 hover:to-vivid-purple/15 transition-all duration-500 shadow-lg transform">
        <p className="text-lg text-white/90 mb-4 animate-fade-in leading-relaxed">
        ...
        <p className="text-lg text-white/80 animate-fade-in leading-relaxed">
